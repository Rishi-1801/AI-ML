...
st.title("Lanchain: Cha with SQL DB")
...
def configure_db(db_uri,mysql_host=None,mysql_user=None,mysql_password=None,mysql_db=None):
    if db_uri==LOCALDB:
        ...
        if (mysql_host is None or mysql_user is None or mysql_password is None or mysql_db is None):
...
user_query=st.chat_input(placeholder="Ask anytghing from the database")
